...
public class DbCimentoCurvaProvisoria extends SQLiteOpenHelper {

    public static int VERSION = 1;
    public static String NOME_DB = "DB_CIMENTO_CURVA_PROVISORIA";
    public static String TABELA_DADOS_CIMENTO = "tabelaDadosCimento";

    public DbCimentoCurvaProvisoria(@Nullable Context context) {
